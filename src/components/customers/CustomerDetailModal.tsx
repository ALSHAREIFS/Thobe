                ...
                {(canReports || canPayments) && (
                  <div className="p-3 bg-stone-50 rounded-2xl border border-stone-200">
                    ...
                    <div className="text-xl font-black text-amber-800 mt-0.5">
                      {formatCurrency(totalPurchases, currentShop?.currency)}
                    </div>
                  </div>
                )}
                {(canReports || canPayments) && (
                    ...
                    >
                      <div>
                        ...
                        <div className="text-xs text-stone-500 mt-1 flex items-center gap-3">
                          ...
                          <span className="font-black text-stone-900">{formatCurrency(order.pricing?.totalAmount, currentShop?.currency)}</span>
                        </div>
                      </div>
